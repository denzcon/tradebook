...
<form name="send_xp" action="" method="post">
					...
					<?php foreach ($users as $user): ?>
						<tr>
							<?php foreach ($user as $k => $v): ?>
								<?php ($k == 'user_id') ? ($user_id = $v) : ''; ?>
								<?php if ($k == 'xp_value'): ?>
									<td>
										<span>
											<input type="text" name="addXP" id="<?= $user_id; ?>" value="0" style="color: rgb(0, 136, 204); font-weight: bold; width: 36px;" class="scrollable_input"/>
	...
	<div class="modal-footer">
		<input type="submit" name="send_xp" id="send_xp" value="Submit" class="btn btn-primary"/>
